  ...
  return (
    <div className="min-h-screen h-full w-full overflow-hidden flex flex-col items-center justify-center bg-brand-background ">
        ...
        />
          ...
          <div className="z-1 md:max-w-3xl w-full bg-black/75 filter backdrop-blur-md py-4 rounded-md px-2 md:px-10 flex flex-col items-center">
            <h1 className="font-Righteous uppercase font-bold text-3xl md:text-4xl bg-gradient-to-br  from-brand-green to-brand-blue bg-clip-text text-transparent mt-3">
            ...
            <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-14">
              <div className="relative w-full">
                ...
                <div className="font-Righteous flex items-center justify-between w-full">
                  <button
                    className="w-12 h-8 md:w-14 md:h-10 flex items-center justify-center text-brand-01 hover:shadow-lg bg-gray-300 font-bold rounded-md"
                  ...
                  <p className="flex items-center justify-center flex-1 grow text-center font-bold text-brand-05 text-3xl md:text-4xl">
                  {mintAmount}
                  </p>
                  <button
                    className="w-12 h-8 md:w-14 md:h-10 flex items-center justify-center text-brand-01 hover:shadow-lg bg-gray-300 font-bold rounded-md"
                ...
                <p className="text-sm text-pink-200 tracking-widest mt-6">
                  Max Mint Amount: {maxMintAmount}
                </p>

                <div className="border-t border-b py-4 mt-10 w-full">
                  <div className="w-full text-xl font-Righteous flex items-center justify-between text-yellow-500">
                    <p>Total</p>
                ...
                {walletAddress ? (
                  <button
                    ...
                    } font-Righteous mt-10  w-full px-6 py-3 rounded-md text-2xl text-white  mx-4 tracking-wide uppercase border-violet-50`}
              ...
              <div
                ...
                {/* Status */}
                {status && (
                  <div className={'border ${ status.success ? 'border-green-500' : 'border-brand-pink-400 '
                    } rounded-md text-start h-full px-4 py-4 w-full mx-auto mt-8 md:mt-4"`}
                  >
                    <p className="flex flex-col space-y-2 text-white text-sm md:text-base break-words ...">
                      {status.message}
                    </p>
                    <p className="text-red-500 flex flex-col space-y-2 text-white text-sm md:text-base break-words ...">
                      Please Make sure you are connected with the right network (Rinkeby test network)
                    </p>
                  </div>
                )}
            ...
            <div className="flex flex-col items-center mt-4 py-2 w-full">
              <h3 className=" text-1xl text-brand-01 uppercase mt-2 font-semibold">
                Contract Address :  
